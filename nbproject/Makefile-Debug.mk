...
${OBJECTDIR}/model/Node.o: model/Node.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Imath -Imodel -MMD -MP -MF $@.d -o ${OBJECTDIR}/model/Node.o model/Node.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Imath -Imodel -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/model/Model.o: model/Model.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} $@.d
	$(COMPILE.cc) -g -Imath -Imodel -MMD -MP -MF $@.d -o ${OBJECTDIR}/model/Model.o model/Model.cpp

${OBJECTDIR}/model/Edge.o: model/Edge.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} $@.d
	$(COMPILE.cc) -g -Imath -Imodel -MMD -MP -MF $@.d -o ${OBJECTDIR}/model/Edge.o model/Edge.cpp
