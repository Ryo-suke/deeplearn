...
${TESTDIR}/_ext/389674410/test_spn.o: /home/hoaivu_pham/NetBeansProjects/deeplearn/tests/test_spn.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -Imath -Imodel -Idata -Iutil -I/home/hoaivu_pham/lib/boost_1_54_0/include -MMD -MP -MF $@.d -o ${TESTDIR}/_ext/389674410/test_spn.o /home/hoaivu_pham/NetBeansProjects/deeplearn/tests/test_spn.cpp


${TESTDIR}/tests/test_train.o: tests/test_train.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -Imath -Imodel -Idata -Iutil -I/home/hoaivu_pham/lib/boost_1_54_0/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test_train.o tests/test_train.cpp


${TESTDIR}/_ext/389674410/test_util.o: /home/hoaivu_pham/NetBeansProjects/deeplearn/tests/test_util.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/389674410
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -Imath -Imodel -Idata -Iutil -I/home/hoaivu_pham/lib/boost_1_54_0/include -MMD -MP -MF $@.d -o ${TESTDIR}/_ext/389674410/test_util.o /home/hoaivu_pham/NetBeansProjects/deeplearn/tests/test_util.cpp
